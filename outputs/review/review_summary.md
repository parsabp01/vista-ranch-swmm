...
- Inflow records mapped: 302
- Inflow matched %: 100.0%
- Strict match %: 98.34%
- Normalized/suffix match %: 1.66%
- Low-confidence match count: 0
- Unresolved count: 0
- Inlet->junction coverage: 100.0%
- Inflow->SWMM node coverage: 100.0%
- BASIN boundary consistency: PASS
- HYDROLOGY final BASIN row: 684
- HYDROLOGY last valid row: 684
- HYDROLOGY trailing rows excluded as non-inputs: 13
